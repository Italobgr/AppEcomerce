...
class quatreef extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            new Container(
              ...
              child: GridTile(
                child: Container(
                  color: Colors.white,
                  child: Image.asset("images/produtosimage/quatreef.jpg"),
                ),
                footer: new Container(
                  color: Colors.white70,
                  child: ListTile(
                    leading: new Text("Quatree Gourmet filhote",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                    title: new Row(
                      children: <Widget>[
                        Expanded(
