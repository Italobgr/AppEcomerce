...
class quatres2 extends StatelessWidget {
  @override
          ...
          children: <Widget>[
            new Container(
              ...
              child: GridTile(
                child: Container(
                  color: Colors.white,
                  child: Image.asset("images/produtosimage/quatres2.png"),
                ),
                footer: new Container(
                  color: Colors.white70,
                  child: ListTile(
                    leading: new Text("Quatree Supreme Adulto RP",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                    title: new Row(
                      children: <Widget>[
                        Expanded(
