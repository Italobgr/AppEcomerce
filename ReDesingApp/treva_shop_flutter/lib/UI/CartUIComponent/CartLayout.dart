            ...
            ListView.builder(
              ...
              itemBuilder: (context,position){
                ...
                return Slidable(
                  ...
                  actions: <Widget>[
                    new IconSlideAction(
                      caption: AppLocalizations.of(context).tr('cartArchiveText'),
                      color: Colors.blue,
                      icon: Icons.archive,
                      onTap: () {
                         ///
                        ...
                        ///
                        Scaffold.of(context)
                            .showSnackBar(SnackBar(content: Text(AppLocalizations.of(context).tr('cartArchice')),duration: Duration(seconds: 2),backgroundColor: Colors.blue,));
                      },
                    ),
                  ],
                  secondaryActions: <Widget>[
                    new IconSlideAction(
                      ...
                      caption: AppLocalizations.of(context).tr('cartDelete'),
                      color: Colors.red,
                      icon: Icons.delete,
                      onTap: () {
                        setState(() {
