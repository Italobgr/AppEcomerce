                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                            AppLocalizations.of(context).tr('longLorem'),      style: _detailText),
                      ),
                      Padding(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: <Widget>[
                              Text(AppLocalizations.of(context).tr('size'), style: _subHeaderCustomStyle),
                              Row(
                                children: <Widget>[
                                  RadioButtonCustom(
                              ...
                              Padding(
                                ...
                                child: Center(
                                  child: InkWell(
                                    ...
                                    child: Text(
                                      AppLocalizations.of(context).tr('viewMore'),
                                      style: TextStyle(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: <Widget>[
                                  Text(AppLocalizations.of(context).tr('review'),style: _subHeaderCustomStyle,),
                                  Padding(
                                      ...
                                      children: <Widget>[
                                        InkWell(
                                          child: Padding(
                                              ...
                                              child: Text(AppLocalizations.of(context).tr('viewAll'),style: _subHeaderCustomStyle.copyWith(color: Colors.indigoAccent,fontSize: 14.0),)),
                                          onTap: () {
                                ...
                                children: <Widget>[
                                  Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        SizedBox(width: 5.0),
                                        Text(AppLocalizations.of(context).tr('reviews'),)
                                      ]),
                                ],
                              ),
                             ...
                             _buildRating(AppLocalizations.of(context).tr('date'),
                                 AppLocalizations.of(context).tr('ratingReview'),    (rating) {
                                    setState(() {
                                      this.rating = rating;
                                    });
                                  },
            ...
            InkWell(
              onTap: () {
                var snackbar = SnackBar(
                  content: Text(AppLocalizations.of(context).tr('itemAdded'),),
                );
                setState(() {
                  valueItemChart++;
                });
