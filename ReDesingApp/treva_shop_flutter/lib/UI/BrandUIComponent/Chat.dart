...
class _privatemessageState extends State<privatemessage>
  ...
  @override
  Widget build(BuildContext ctx) {/// Declare default User Name
            ...
            children: <Widget>[
                ...
                child: Padding(
                  ...
                  child: new TextField(
                    ...
                    decoration: new InputDecoration.collapsed(
                        hintText:  AppLocalizations.of(context).tr('hintMessage'),
                        hintStyle: TextStyle(
                            fontFamily: "Sans",
                            fontSize: 16.0,
              ...
              new Container(
                  ...
                  child: Theme.of(context).platform == TargetPlatform.iOS
                      ? new CupertinoButton(
                          child: new Text( AppLocalizations.of(context).tr('submit')),
        ...
        child: Container(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text( AppLocalizations.of(context).tr('notHaveMessage'), style: TextStyle( fontWeight: FontWeight.w300,color: Colors.black12,fontSize: 17.0,fontFamily: "Popins"),)
            ],
          ),
        ));
  }
