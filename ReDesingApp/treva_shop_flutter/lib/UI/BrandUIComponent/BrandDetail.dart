            ...
            child: new Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(  AppLocalizations.of(context).tr('sortBy'), style: _fontCostumSheetBotomHeader),
                  Padding(padding: EdgeInsets.only(top: 20.0)),
                  Container(
                    width: 500.0,
          ...
          return SingleChildScrollView(
            child: new Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(padding: EdgeInsets.only(top: 20.0)),
                  Text(  AppLocalizations.of(context).tr('refineBy'), style: _fontCostumSheetBotomHeader),
                  Padding(padding: EdgeInsets.only(top: 20.0)),
                  Container(
                    width: 500.0,
                    color: Colors.black26,
        ...
        body: SafeArea(
            ...
            slivers: <Widget>[
               ...
               SliverPersistentHeader( 
                  delegate:  MySliverAppBar(expandedHeight: _height-40.0,img: brand.img,title: brand.name,id:brand.id),
                  pinned: true,
                ),
